...
class NavigationPlanner:
    ...
    def displayMap(self):
        map3 = cv2.imread("map.png")
        # for node in self.openlist:
        #     map3[node.pos[1]][node.pos[0]] = 170
        # for node in self.closelist:
        # #     map3[node.pos[1]][node.pos[0]] = 100
...
# # Drawing
# cv2.circle(map,my_start,2,(50,255,50),5)
# cv2.circle(map,my_goal,2,(50,50,255),5)
# for node in nav.navPlan:
#     map[node.pos[1]][node.pos[0]] = (255,50,50)
